...
def ensure_columns():
    stmts = [
        ...
        "CREATE INDEX ix_doubts_teacher_status ON doubts (teacher_id, status)",
        "CREATE INDEX ix_doubts_student ON doubts (student_id)",
        "CREATE INDEX ix_doubts_subject_status ON doubts (subject, status)",
        "CREATE INDEX ix_dresp_doubt ON doubt_responses (doubt_id)",
        "CREATE INDEX ix_sp_lastseen ON student_profiles (last_seen)",
        "CREATE INDEX ix_sp_token ON student_profiles (active_session_token)",
        "CREATE INDEX ix_usess_user_seen ON user_sessions (user_id, last_seen)",
        "CREATE INDEX ix_sbatch_student ON student_batches (student_id)",
        "CREATE INDEX ix_sbatch_batch ON student_batches (batch_id)",
        "CREATE INDEX ix_materials_batch ON materials (batch_id)",
